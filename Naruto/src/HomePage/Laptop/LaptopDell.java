...
public class LaptopDell {
    ...
    public void DetailDellForm() {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/Display/Detail/DetailDell.fxml"));
            Stage detailAppleStage = new Stage();
            detailAppleStage.setTitle("DELL");
    ...
    public void New1() {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/Display/WebView/Dell/New1.fxml"));
    ...
    public void New2() {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/Display/WebView/Dell/New2.fxml"));
            Stage newPage = new Stage();
            newPage.setTitle("New");
            newPage.setScene(new Scene(root, 1280, 700));
            newPage.show();
    ...
    public void New3() {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/Display/WebView/Dell/New3.fxml"));
            Stage newPage = new Stage();
            newPage.setTitle("New");
            newPage.setScene(new Scene(root, 1280, 700));
            newPage.show();
