...
public class LaptopThinkPad {
    public MenuButton infoMenuButton;
    public void DetailTPForm() {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/Display/Detail/DetailThinkPad.fxml"));
            Stage tpHPStage = new Stage();
            tpHPStage.setTitle("HP");
            tpHPStage.setScene(new Scene(root, 700, 700));
            tpHPStage.show();
        } catch (Exception e) {
            e.printStackTrace();
            e.getCause();
    ...
    public void New1() {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/Display/WebView/ThinkPad/New1.fxml"));
    ...
    public void New2() {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/Display/WebView/ThinkPad/New2.fxml"));
            Stage newPage = new Stage();
            newPage.setTitle("New");
            newPage.setScene(new Scene(root, 1280, 700));
            newPage.show();
    ...
    public void New3() {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/Display/WebView/ThinkPad/New3.fxml"));
            Stage newPage = new Stage();
            newPage.setTitle("New");
            newPage.setScene(new Scene(root, 1280, 700));
            newPage.show();
